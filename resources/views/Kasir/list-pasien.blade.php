  ...
  <x-data-table-client-side>
    ...
    <tbody>
      ...
      <tr>
        ...
        @if($pasien->status_kasir == 1)
        <td>
          <form action="{{route('kasir.detail-pasien',$pasien)}}" method="post">
            @csrf
        ...
        @else
        <td>
          <a href="{{ route('kasir.detail-pasien',$pasien)}}" class="btn btn-success">Proses</a>
        </td>
        @endif
      </tr>
      @endforeach
